...
const { WorkerHost, detach, attach, destroy,
        requiresAddonGlobal } = require("sdk/worker/utils");
...
const { filter, pipe } = require("sdk/event/utils");
const { getNodeView, getActiveView } = require("sdk/view/core");
const { isNil, isObject } = require("sdk/lang/type");
