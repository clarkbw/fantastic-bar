...
function frameWatcher(safeWin) {
  if (!('document' in safeWin && 'frameElement' in safeWin && safeWin.document.documentElement)) {
    return;
  }

  //console.log('TRYING')
  //console.log(safeWin.frameElement && safeWin.frameElement.src)
}
